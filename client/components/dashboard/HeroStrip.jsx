 ...
 * @param {function} props.onNotificationClick - Opens the notifications panel
 */
export default function HeroStrip({ pendingDuesCount, notificationCount = 0, onNotificationClick }) {
  return (
